...
<body>
	            ...
	            <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Notes</h4>
    			...
    			<div class="container-fluid note-has-grid">
    				<ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
                                  ...
                                  <li class="nav-item"> <a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-business">
                                    <i class="icon-layers mr-1"></i><span class="d-none d-md-block">보낸쪽지함</span></a> 
                                  </li>
                                  <li class="nav-item"> <a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-social">
                                    <span class="d-none d-md-block">휴지통</span></a> 
                                  </li>
                                  <li class="nav-item"> <a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-important">
                                    <span class="d-none d-md-block">임시보관함</span></a> 
                                  </li>
                            ...
                            <div  id="note-full-container" class="note-has-grid row">
                                <div class="col-md-4 single-note-item all-category">
                                    <div class="card card-body">
                                        ...
                                        <h5 class="note-title text-truncate w-75 mb-0" data-noteHeading="Book a Ticket for Movie">메세지제목입니다</h5>
                                        <p class="note-date font-12 text-muted">인사부 홍길동</p>
                                        <p class="note-date font-12 text-muted">2022.10.04. 11:00</p>
                                        <div class="note-content">
                                                    <p class="note-inner-content text-muted" data-noteContent="메세지내용입니다">메세지내용입니다</p>
                                              </div>
                                              <div class="d-flex align-items-center">
    				...
    				<div class="modal fade" id="addnotesmodal" tabindex="-1" role="dialog" aria-labelledby="addnotesmodalTitle" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered" role="document">
    						        	...
    						        	<h5 class="modal-title text-white">Send Message</h5>
    						        	<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                                              	  ...
                                                              	  <label>To.</label>
                                                              	   <select class="select2 form-control" multiple="multiple"
									                                    ...
									                                    <optgroup label="경영지원부">
									                                        <option value="AK">김땡땡</option>
									                                        <option value="HI">이땡땡</option>
									                                    </optgroup>
									                                    <optgroup label="총무부">
									                                        <option value="CA">최땡땡</option>
									                                        <option value="NV">홍길동</option>
									                                        <option value="OR">곽보결</option>
									                                        <option value="WA">이수진</option>
									                                    </optgroup>
									                                    <optgroup label="인사부">
									                                        <option value="AZ">김소영</option>
									                                        <option value="CO">최진우</option>
									                                        <option value="ID">김영수</option>
									                                        <option value="MT">이건호</option>
									                                        <option value="NE">황영석</option>
									                                    </optgroup>
									                                </select>
                                                              	  </div>
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <button type = "button" class="btn btn-info" onclick = "();">send</button>
                                          </div>
                                      </div>
                                  </div>
                              </div>
	...
	<script src="${path}/resources/dist/js/pages/notes/notes.js"></script>
	    <script src="${path}/resources/assets/libs/select2/dist/js/select2.full.min.js"></script>
    <script src="${path}/resources/assets/libs/select2/dist/js/select2.min.js"></script>
    <script src="${path}/resources/dist/js/pages/forms/select2/select2.init.js"></script>
</body>
