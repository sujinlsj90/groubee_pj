			...
			<!-- ============================================================== -->
    			...
    			<div class="container-fluid note-has-grid">
    				<ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
						<li class="nav-item"> 
							<a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center active px-2 px-md-3 mr-0 mr-md-2"  id="getMsg">
						  		<i class="icon-folder-alt mr-1"></i><span class="d-none d-md-block">받은쪽지함</span>
						  	</a> 
						</li>
						<li class="nav-item"> 
							<a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="sendMsg">
						 		<i class="icon-folder mr-1"></i><span class="d-none d-md-block">보낸쪽지함</span>
						  	</a> 
						</li>
						<li class="nav-item"> 
							<a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="trashMsg">
						  		<i class="icon-trash mr-1"></i><span class="d-none d-md-block">휴지통</span>
						  	</a>
						</li>
						<li class="nav-item"> 
							<a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="tempoMsg">
						  		<i class="icon-drawar mr-1"></i><span class="d-none d-md-block">임시보관함</span>
						  	</a> 
						</li>
						<li class="nav-item ml-auto"> 
							<a href="javascript:void(0)" class="nav-link<!--  btn-primary --> rounded-pill d-flex align-items-center px-3" id="writeMsg" style="height:37px;">
                    	...
                    	<div id="note-full-container" class="note-has-grid row">
                        	<div class="col-md-4 single-note-item all-category">
                            	<div class="card card-body">
	                                ...
	                                <h5 class="note-title text-truncate w-75 mb-0" data-noteHeading="Book a Ticket for Movie">메세지 제목입니다<i class="point fas fa-circle ml-1 font-10"></i></h5>
