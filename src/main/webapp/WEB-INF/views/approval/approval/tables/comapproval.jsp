                    ...
                    <div class="bg-light p-3 d-flex align-items-center do-block">
                        <div class="btn-group mt-1 mb-1">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="cstall">Check All  기안문서함 > 완료문서</label>
                            </div>
                        </div>
                        <div class="ml-auto">
                            <div class="btn-group mr-2" role="group" aria-label="Button group with nested dropdown">
                                <button type="button" class="btn btn-outline-secondary font-18" onclick="location.href='${path}/onapproval.ap'">완료</button>
                        ...
                        <table class="table email-table no-wrap table-hover v-middle">
                            <tbody>
                                ...
                                <tr class="unread">
                                    ...
                                    <td class="py-2 px-3 no-wrap text-truncate"> 
                                            <span class="blue-grey-text text-darken-4">Spring project 완료 계획 보고</span>
                                    </td>
                                    <td class="clip px-1 py-2"><i class="fa fa-paperclip"></i></td>
